...
public class Catalog implements GlobalConst {
  ...
  /**
   * Gets the number of records in a specified relation
   * @param fileName the name of the relation to fetch
   *  
   * @return number of records in file or -1 if relation dne
   **/
